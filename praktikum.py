...
def main():
    ...
    vehicles_data = [
        ...
        {"id": 3, "type": "Exotic", "brand": "Lamborghini", "model": "Gallardo Superleggera", "year": 2007, "price": 300000},
    ...
    while True:
        ...
        typewriter_effect("3. Leave Showroom")
        typewriter_effect("=" * 45)
        ...
        try:
            ...
            if choice == 1:
                ...
                typewriter_effect("Your purchased vehicles:")
